...
createErrorFromNameLookup.set(
  ...
  () => new TradeStateDoesntExistError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new MissingAuctioneerScopeError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new NoAuctioneerProgramSetError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new BuyerTradeStateNotValidError()
)
...
export class SaleRequiresExactlyOneSignerError extends Error {
  ...
  constructor() {
    super(
      'This sale requires exactly one signer: either the seller or the authority.'
    )
    if (typeof Error.captureStackTrace === 'function') {
