...
const programKeypairPath = path.join(__dirname, "..","target/deploy/auction_house_v2-keypair.json");
...
const PROGRAM_NAME = "auction_house_v2";
const PROGRAM_ID = publicKey;

const programDir = path.join(__dirname, "..", "programs/auction-house-v2");
